...
export const TUTORIAL_ORDER_DETAIL = {
  ...
  orderType: "PRINT_ONLY" as "PRINT_ONLY" | "DESIGN",
  sourceLinks: [] as Array<{ id: string; url: string; label: string | null }>,
  isPrototype: false,
  iterationCount: 0,
  ...
  return {
    ...
    parts: [{
      ...
      orderPart: {
        ...
        orderId: TUTORIAL_ORDER_ID,
        name: "Elektronen-Träger",
        material: withFilament.material,
        materialAny: false,
        color: withFilament.color,
        colorHex: withFilament.colorHex,
        colorAny: false,
        pricePerKg: null,
        quantity: 3,
        files: [
